...
/** Category of additions for `<YDFMDatabase>` class.
...
@interface YDFMDatabase (YDFMDatabaseAdditions)
...
/** Return `int` value for query
 ...
 @note To use this method from Swift, you must include `YDFMDatabaseAdditionsVariadic.swift` in your project.
 */
...
/** The schema of the database.
 ...
 @return `YDFMResultSet` of schema; `nil` on error.
