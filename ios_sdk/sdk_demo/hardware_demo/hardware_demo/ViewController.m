...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(syncFinished:) name:kYDNtfOpenHardwareSyncFinished object:nil];
}
...
- (void)syncFinished:(NSNotification *)notification {
    NSLog(@"sync status: %@", notification.object);
}
@end
